...
enum class RecordFlagBits : uint32_t;
} // namespace VMA_HPP_NAMESPACE
...
VULKAN_HPP_INLINE std::string to_string(MemoryUsage value)
{
	...
	case MemoryUsage::eCpuCopy:
		return "CpuCopy";
	case MemoryUsage::eGpuLazilyAllocated:
		return "GpuLazilyAllocated";
	default:
		return "invalid";
	}
}
...
VULKAN_HPP_INLINE std::string to_string(AllocationCreateFlagBits value)
{
	switch (value)
	{
	case AllocationCreateFlagBits::eDedicatedMemory:
		return "DedicatedMemory";
	case AllocationCreateFlagBits::eNeverAllocate:
		return "NeverAllocate";
	case AllocationCreateFlagBits::eMapped:
		return "Mapped";
	case AllocationCreateFlagBits::eCanBecomeLost:
		return "CanBecomeLost";
	case AllocationCreateFlagBits::eCanMakeOtherLost:
		return "CanMakeOtherLost";
	case AllocationCreateFlagBits::eUserDataCopyString:
		return "UserDataCopyString";
	case AllocationCreateFlagBits::eUpperAddress:
		return "UpperAddress";
	case AllocationCreateFlagBits::eDontBind:
		return "DontBind";
	case AllocationCreateFlagBits::eWithinBudget:
		return "WithinBudget";
	case AllocationCreateFlagBits::eStrategyBestFit:
		return "StrategyBestFit";
	case AllocationCreateFlagBits::eStrategyWorstFit:
		return "StrategyWorstFit";
	case AllocationCreateFlagBits::eStrategyFirstFit:
...
{
template <>
struct ::VULKAN_HPP_NAMESPACE::FlagTraits<
    VMA_HPP_NAMESPACE::AllocationCreateFlagBits>
{
	enum
	{
		allFlags
		= VkFlags(VMA_HPP_NAMESPACE::AllocationCreateFlagBits::eDedicatedMemory)
		  ...
		  | VkFlags(
		      VMA_HPP_NAMESPACE::AllocationCreateFlagBits::eCanMakeOtherLost)
		  | VkFlags(
		  ...
		  | VkFlags(
		      VMA_HPP_NAMESPACE::AllocationCreateFlagBits::eStrategyWorstFit)
		  | VkFlags(
		  ...
		  | VkFlags(VMA_HPP_NAMESPACE::AllocationCreateFlagBits::
		                eStrategyMinFragmentation)
...
using AllocationCreateFlags
    = VULKAN_HPP_NAMESPACE::Flags<AllocationCreateFlagBits>;

VULKAN_HPP_INLINE AllocationCreateFlags
operator|(AllocationCreateFlagBits bit0, AllocationCreateFlagBits bit1)
{
...
VULKAN_HPP_INLINE std::string to_string(AllocationCreateFlags value)
{
	...
	if (value & AllocationCreateFlagBits::eDedicatedMemory)
		result += "DedicatedMemory | ";
	if (value & AllocationCreateFlagBits::eNeverAllocate)
		result += "NeverAllocate | ";
	if (value & AllocationCreateFlagBits::eMapped)
		result += "Mapped | ";
	if (value & AllocationCreateFlagBits::eCanBecomeLost)
		result += "CanBecomeLost | ";
	if (value & AllocationCreateFlagBits::eCanMakeOtherLost)
		result += "CanMakeOtherLost | ";
	if (value & AllocationCreateFlagBits::eUserDataCopyString)
		result += "UserDataCopyString | ";
	if (value & AllocationCreateFlagBits::eUpperAddress)
		result += "UpperAddress | ";
	if (value & AllocationCreateFlagBits::eDontBind)
		result += "DontBind | ";
	if (value & AllocationCreateFlagBits::eWithinBudget)
		result += "WithinBudget | ";
	if (value & AllocationCreateFlagBits::eStrategyBestFit)
		result += "StrategyBestFit | ";
	if (value & AllocationCreateFlagBits::eStrategyWorstFit)
		result += "StrategyWorstFit | ";
	if (value & AllocationCreateFlagBits::eStrategyFirstFit)
		result += "StrategyFirstFit | ";
	if (value & AllocationCreateFlagBits::eStrategyMinMemory)
		result += "StrategyMinMemory | ";
	if (value & AllocationCreateFlagBits::eStrategyMinTime)
		result += "StrategyMinTime | ";
	if (value & AllocationCreateFlagBits::eStrategyMinFragmentation)
		result += "StrategyMinFragmentation | ";
...
VULKAN_HPP_INLINE std::string to_string(AllocatorCreateFlagBits value)
{
	switch (value)
	{
	case AllocatorCreateFlagBits::eExternallySynchronized:
		return "ExternallySynchronized";
	case AllocatorCreateFlagBits::eKhrDedicatedAllocation:
		return "KhrDedicatedAllocation";
	case AllocatorCreateFlagBits::eKhrBindMemory2:
		return "KhrBindMemory2";
	case AllocatorCreateFlagBits::eExtMemoryBudget:
		return "ExtMemoryBudget";
	default:
		return "invalid";
	}
}
...
struct FlagTraits<VMA_HPP_NAMESPACE::AllocatorCreateFlagBits>
{
	...
	{
		allFlags
		= VkFlags(VMA_HPP_NAMESPACE::AllocatorCreateFlagBits::
		              eExternallySynchronized)
		  | VkFlags(VMA_HPP_NAMESPACE::AllocatorCreateFlagBits::
		                eKhrDedicatedAllocation)
...
using AllocatorCreateFlags
    = VULKAN_HPP_NAMESPACE::Flags<AllocatorCreateFlagBits>;

VULKAN_HPP_INLINE AllocatorCreateFlags
operator|(AllocatorCreateFlagBits bit0, AllocatorCreateFlagBits bit1)
{
...
VULKAN_HPP_INLINE std::string to_string(AllocatorCreateFlags value)
{
	...
	if (value & AllocatorCreateFlagBits::eExternallySynchronized)
		result += "ExternallySynchronized | ";
	if (value & AllocatorCreateFlagBits::eKhrDedicatedAllocation)
		result += "KhrDedicatedAllocation | ";
	if (value & AllocatorCreateFlagBits::eKhrBindMemory2)
		result += "KhrBindMemory2 | ";
	if (value & AllocatorCreateFlagBits::eExtMemoryBudget)
		result += "ExtMemoryBudget | ";
	return "{ " + result.substr(0, result.size() - 3) + " }";
}
...
using DefragmentationFlags
    = VULKAN_HPP_NAMESPACE::Flags<DefragmentationFlagBits>;

VULKAN_HPP_INLINE std::string to_string(DefragmentationFlags) { return "{}"; }
...
VULKAN_HPP_INLINE std::string to_string(PoolCreateFlagBits value)
{
	switch (value)
	{
	case PoolCreateFlagBits::eIgnoreBufferImageGranularity:
		return "IgnoreBufferImageGranularity";
	case PoolCreateFlagBits::eLinearAlgorithm:
		return "LinearAlgorithm";
	case PoolCreateFlagBits::eBuddyAlgorithm:
		return "BuddyAlgorithm";
	case PoolCreateFlagBits::eAlgorithmMask:
...
struct FlagTraits<VMA_HPP_NAMESPACE::PoolCreateFlagBits>
{
	...
	{
		allFlags
		= VkFlags(VMA_HPP_NAMESPACE::PoolCreateFlagBits::
		              eIgnoreBufferImageGranularity)
...
VULKAN_HPP_INLINE PoolCreateFlags
operator|(PoolCreateFlagBits bit0, PoolCreateFlagBits bit1)
{
...
VULKAN_HPP_INLINE std::string to_string(PoolCreateFlags value)
{
	...
	if (value & PoolCreateFlagBits::eIgnoreBufferImageGranularity)
		result += "IgnoreBufferImageGranularity | ";
	if (value & PoolCreateFlagBits::eLinearAlgorithm)
		result += "LinearAlgorithm | ";
	if (value & PoolCreateFlagBits::eBuddyAlgorithm)
		result += "BuddyAlgorithm | ";
	return "{ " + result.substr(0, result.size() - 3) + " }";
}
...
VULKAN_HPP_INLINE std::string to_string(RecordFlagBits value)
{
	switch (value)
	{
	case RecordFlagBits::eFlushAfterCall:
		return "FlushAfterCall";
	default:
		return "invalid";
	}
}
...
VULKAN_HPP_INLINE RecordFlags
operator|(RecordFlagBits bit0, RecordFlagBits bit1)
{
...
VULKAN_HPP_INLINE std::string to_string(RecordFlags value)
{
	...
	if (value & RecordFlagBits::eFlushAfterCall)
		result += "FlushAfterCall | ";
	return "{ " + result.substr(0, result.size() - 3) + " }";
}
...
class Allocator
{
	...
	public:
	VULKAN_HPP_CONSTEXPR Allocator() : m_allocator(VK_NULL_HANDLE) {}

	VULKAN_HPP_CONSTEXPR Allocator(std::nullptr_t) : m_allocator(VK_NULL_HANDLE)
	{
	}
	...
	VULKAN_HPP_NAMESPACE::Result allocateMemory(
	    const VULKAN_HPP_NAMESPACE::MemoryRequirements *pVkMemoryRequirements,
	    const AllocationCreateInfo *pCreateInfo,
	    Allocation *pAllocation,
	    AllocationInfo *pAllocationInfo) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<Allocation>::type allocateMemory(
	...
	VULKAN_HPP_NAMESPACE::Result allocateMemoryForBuffer(
	    VULKAN_HPP_NAMESPACE::Buffer buffer,
	    const AllocationCreateInfo *pCreateInfo,
	    Allocation *pAllocation,
	    AllocationInfo *pAllocationInfo) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<Allocation>::type
	...
	VULKAN_HPP_NAMESPACE::Result allocateMemoryForImage(
	...
	VULKAN_HPP_NAMESPACE::Result allocateMemoryPages(
	    const VULKAN_HPP_NAMESPACE::MemoryRequirements *pVkMemoryRequirements,
	    const AllocationCreateInfo *pCreateInfo,
	    size_t allocationCount,
	    Allocation *pAllocations,
	    AllocationInfo *pAllocationInfos) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	template <typename VectorAllocator = std::allocator<AllocationInfo>>
	typename VULKAN_HPP_NAMESPACE::ResultValueType<
	    std::vector<AllocationInfo, VectorAllocator>>::type
	allocateMemoryPages(
	    const VULKAN_HPP_NAMESPACE::MemoryRequirements &vkMemoryRequirements,
	    const AllocationCreateInfo &createInfo,
	    VULKAN_HPP_NAMESPACE::ArrayProxy<Allocation> allocations) const;
	template <typename VectorAllocator = std::allocator<AllocationInfo>>
	typename VULKAN_HPP_NAMESPACE::ResultValueType<
	    std::vector<AllocationInfo, VectorAllocator>>::type
	allocateMemoryPages(
	    const VULKAN_HPP_NAMESPACE::MemoryRequirements &vkMemoryRequirements,
	    const AllocationCreateInfo &createInfo,
	    VULKAN_HPP_NAMESPACE::ArrayProxy<Allocation> allocations,
	    Allocator const &vectorAllocator) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::Result bindBufferMemory(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::Buffer buffer) const;
#else
	VULKAN_HPP_NAMESPACE::ResultValueType<void>::type bindBufferMemory(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::Buffer buffer) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::Result bindBufferMemory2(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
	    VULKAN_HPP_NAMESPACE::Buffer buffer,
	    const void *pNext) const;
#else
	VULKAN_HPP_NAMESPACE::ResultValueType<void>::type bindBufferMemory2(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
	    VULKAN_HPP_NAMESPACE::Buffer buffer,
	    const void *pNext) const;
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::Result bindImageMemory(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::Image image) const;
#else
	VULKAN_HPP_NAMESPACE::ResultValueType<void>::type bindImageMemory(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::Image image) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::Result bindImageMemory2(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
	    VULKAN_HPP_NAMESPACE::Image image,
	    const void *pNext) const;
#else
	VULKAN_HPP_NAMESPACE::ResultValueType<void>::type bindImageMemory2(
	    Allocation allocation,
	    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
	    VULKAN_HPP_NAMESPACE::Image image,
	    const void *pNext) const;
	...
	VULKAN_HPP_NAMESPACE::Result createBuffer(
	...
	VULKAN_HPP_NAMESPACE::ResultValueType<
	    std::pair<VULKAN_HPP_NAMESPACE::Buffer, vma::Allocation>>::type
	createBuffer(
	...
	VULKAN_HPP_NAMESPACE::Result createImage(
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<
	    std::pair<VULKAN_HPP_NAMESPACE::Image, vma::Allocation>>::type
	createImage(
	...
	createPool(const PoolCreateInfo *pCreateInfo, Pool *pPool) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<Pool>::type
	createPool(const PoolCreateInfo &createInfo) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

	VULKAN_HPP_NAMESPACE::Result defragmentationBegin(
	    const DefragmentationInfo2 *pInfo,
	    DefragmentationStats *pStats,
	    DefragmentationContext *pContext) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<DefragmentationContext>::type
	defragmentationBegin(
	    const DefragmentationInfo2 &info,
	    VULKAN_HPP_NAMESPACE::Optional<DefragmentationStats> stats
	    = nullptr) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::Result
	defragmentationEnd(DefragmentationContext context) const;
#else
	VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
	defragmentationEnd(DefragmentationContext context) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
	...
	void destroyImage(VULKAN_HPP_NAMESPACE::Image image, Allocation allocation)
	    const;

	void destroyPool(Pool pool) const;

	VULKAN_HPP_NAMESPACE::Result findMemoryTypeIndex(
	    uint32_t memoryTypeBits,
	    const AllocationCreateInfo *pAllocationCreateInfo,
	    uint32_t *pMemoryTypeIndex) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<uint32_t>::type findMemoryTypeIndex(
	    uint32_t memoryTypeBits,
	    const AllocationCreateInfo &allocationCreateInfo) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

	VULKAN_HPP_NAMESPACE::Result findMemoryTypeIndexForBufferInfo(
	    const VULKAN_HPP_NAMESPACE::BufferCreateInfo *pBufferCreateInfo,
	    const AllocationCreateInfo *pAllocationCreateInfo,
	    uint32_t *pMemoryTypeIndex) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<uint32_t>::type
	findMemoryTypeIndexForBufferInfo(
	    const VULKAN_HPP_NAMESPACE::BufferCreateInfo &bufferCreateInfo,
	    const AllocationCreateInfo &allocationCreateInfo) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

	VULKAN_HPP_NAMESPACE::Result findMemoryTypeIndexForImageInfo(
	    const VULKAN_HPP_NAMESPACE::ImageCreateInfo *pImageCreateInfo,
	    const AllocationCreateInfo *pAllocationCreateInfo,
	    uint32_t *pMemoryTypeIndex) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	...
	void
	freeMemoryPages(size_t allocationCount, Allocation *pAllocations) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	...
	VULKAN_HPP_NAMESPACE::Result
	mapMemory(Allocation allocation, void **ppData) const;
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
	VULKAN_HPP_NAMESPACE::ResultValueType<void *>::type
	...
	explicit operator bool() const { return m_allocator != VK_NULL_HANDLE; }

	bool operator!() const { return m_allocator == VK_NULL_HANDLE; }

	private:
	VmaAllocator m_allocator;
};
static_assert(
    sizeof(Allocator) == sizeof(VmaAllocator),
...
class Pool
{
	...
	public:
	VULKAN_HPP_CONSTEXPR Pool() : m_pool(VK_NULL_HANDLE) {}

	VULKAN_HPP_CONSTEXPR Pool(std::nullptr_t) : m_pool(VK_NULL_HANDLE) {}

	VULKAN_HPP_TYPESAFE_EXPLICIT Pool(VmaPool pool) : m_pool(pool) {}
	...
	bool operator==(Pool const &rhs) const { return m_pool == rhs.m_pool; }

	bool operator!=(Pool const &rhs) const { return m_pool != rhs.m_pool; }

	bool operator<(Pool const &rhs) const { return m_pool < rhs.m_pool; }

	VULKAN_HPP_TYPESAFE_EXPLICIT operator VmaPool() const { return m_pool; }

	explicit operator bool() const { return m_pool != VK_NULL_HANDLE; }

	bool operator!() const { return m_pool == VK_NULL_HANDLE; }

	private:
	VmaPool m_pool;
};
static_assert(
    sizeof(Pool) == sizeof(VmaPool),
    "handle and wrapper have different size!");
...
class Allocation
{
	...
	public:
	VULKAN_HPP_CONSTEXPR Allocation() : m_allocation(VK_NULL_HANDLE) {}
	...
	explicit operator bool() const { return m_allocation != VK_NULL_HANDLE; }

	bool operator!() const { return m_allocation == VK_NULL_HANDLE; }

	private:
	VmaAllocation m_allocation;
};
static_assert(
    sizeof(Allocation) == sizeof(VmaAllocation),
    "handle and wrapper have different size!");
...
class DefragmentationContext
{
	...
	DefragmentationContext(VmaDefragmentationContext defragmentationContext)
	...
	operator=(VmaDefragmentationContext defragmentationContext)
	{
		m_defragmentationContext = defragmentationContext;
		return *this;
	}
...
VULKAN_HPP_NAMESPACE::Result
createAllocator(const AllocatorCreateInfo *pCreateInfo, Allocator *pAllocator);
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_NAMESPACE::ResultValueType<Allocator>::type
...
struct AllocationCreateInfo
{
	AllocationCreateInfo(
	    AllocationCreateFlags flags_ = AllocationCreateFlags(),
	    ...
	    : flags(flags_), usage(usage_), requiredFlags(requiredFlags_),
	      preferredFlags(preferredFlags_), memoryTypeBits(memoryTypeBits_),
	...
	AllocationCreateInfo &
	setRequiredFlags(VULKAN_HPP_NAMESPACE::MemoryPropertyFlags requiredFlags_)
	{
	...
	AllocationCreateInfo &
	setPreferredFlags(VULKAN_HPP_NAMESPACE::MemoryPropertyFlags preferredFlags_)
	{
	...
	{
		return (flags == rhs.flags) && (usage == rhs.usage)
		       && (requiredFlags == rhs.requiredFlags)
		       && (preferredFlags == rhs.preferredFlags)
		       && (memoryTypeBits == rhs.memoryTypeBits) && (pool == rhs.pool)
...
static_assert(
    sizeof(AllocationCreateInfo) == sizeof(VmaAllocationCreateInfo),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<AllocationCreateInfo>::value,
    "struct wrapper is not a standard layout!");

struct AllocationInfo
{
	AllocationInfo(
	    uint32_t memoryType_ = 0,
	    ...
	    void *pUserData_ = nullptr)
	    : memoryType(memoryType_), deviceMemory(deviceMemory_), offset(offset_),
	      size(size_), pMappedData(pMappedData_), pUserData(pUserData_)
	{
	}
	...
	AllocationInfo &
	setDeviceMemory(VULKAN_HPP_NAMESPACE::DeviceMemory deviceMemory_)
	{
	...
	bool operator==(AllocationInfo const &rhs) const
	{
		return (memoryType == rhs.memoryType)
		       && (deviceMemory == rhs.deviceMemory) && (offset == rhs.offset)
		       && (size == rhs.size) && (pMappedData == rhs.pMappedData)
		       && (pUserData == rhs.pUserData);
	}
...
static_assert(
    sizeof(AllocationInfo) == sizeof(VmaAllocationInfo),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<AllocationInfo>::value,
    "struct wrapper is not a standard layout!");

struct DeviceMemoryCallbacks
{
	DeviceMemoryCallbacks(
	    PFN_vmaAllocateDeviceMemoryFunction pfnAllocate_ = nullptr,
	...
	DeviceMemoryCallbacks &
	setPfnAllocate(PFN_vmaAllocateDeviceMemoryFunction pfnAllocate_)
	{
...
static_assert(
    sizeof(DeviceMemoryCallbacks) == sizeof(VmaDeviceMemoryCallbacks),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<DeviceMemoryCallbacks>::value,
    "struct wrapper is not a standard layout!");
...
struct VulkanFunctions
{
	VulkanFunctions(
	    ...
	    : vkGetPhysicalDeviceProperties(vkGetPhysicalDeviceProperties_),
	      vkGetPhysicalDeviceMemoryProperties(
	          vkGetPhysicalDeviceMemoryProperties_),
	      vkAllocateMemory(vkAllocateMemory_), vkFreeMemory(vkFreeMemory_),
	      vkMapMemory(vkMapMemory_), vkUnmapMemory(vkUnmapMemory_),
	      ...
	      vkCreateBuffer(vkCreateBuffer_), vkDestroyBuffer(vkDestroyBuffer_),
	      vkCreateImage(vkCreateImage_), vkDestroyImage(vkDestroyImage_),
	...
	VulkanFunctions &
	setVkBindBufferMemory(PFN_vkBindBufferMemory vkBindBufferMemory_)
	{
		vkBindBufferMemory = vkBindBufferMemory_;
		return *this;
	}
	...
	VulkanFunctions &
	setVkBindImageMemory(PFN_vkBindImageMemory vkBindImageMemory_)
	{
		vkBindImageMemory = vkBindImageMemory_;
		return *this;
	}
...
#if VMA_DEDICATED_ALLOCATION || VMA_VULKAN_VERSION >= 1001000
	VulkanFunctions &
	setVkGetBufferMemoryRequirements2KHR(PFN_vkGetBufferMemoryRequirements2KHR
	                                         vkGetBufferMemoryRequirements2KHR_)
	{
		vkGetBufferMemoryRequirements2KHR = vkGetBufferMemoryRequirements2KHR_;
		return *this;
	}
...
#endif
#if VMA_BIND_MEMORY2 || VMA_VULKAN_VERSION >= 1001000
	VulkanFunctions &setVkBindBufferMemory2KHR(
	...
	VulkanFunctions &
	setVkBindImageMemory2KHR(PFN_vkBindImageMemory2KHR vkBindImageMemory2KHR_)
	{
		vkBindImageMemory2KHR = vkBindImageMemory2KHR_;
		return *this;
	}
	...
	bool operator==(VulkanFunctions const &rhs) const
	{
		return (vkGetPhysicalDeviceProperties
		        == rhs.vkGetPhysicalDeviceProperties)
		       && (vkGetPhysicalDeviceMemoryProperties
		           == rhs.vkGetPhysicalDeviceMemoryProperties)
		       ...
		       && (vkInvalidateMappedMemoryRanges
		           == rhs.vkInvalidateMappedMemoryRanges)
		       && (vkBindBufferMemory == rhs.vkBindBufferMemory)
		       && (vkBindImageMemory == rhs.vkBindImageMemory)
		       && (vkGetBufferMemoryRequirements
		           == rhs.vkGetBufferMemoryRequirements)
		       && (vkGetImageMemoryRequirements
		           == rhs.vkGetImageMemoryRequirements)
		       ...
		       && (vkGetBufferMemoryRequirements2KHR
		           == rhs.vkGetBufferMemoryRequirements2KHR)
		       && (vkGetImageMemoryRequirements2KHR
		           == rhs.vkGetImageMemoryRequirements2KHR)
#endif
#if VMA_BIND_MEMORY2 || VMA_VULKAN_VERSION >= 1001000
...
static_assert(
    sizeof(VulkanFunctions) == sizeof(VmaVulkanFunctions),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<VulkanFunctions>::value,
    "struct wrapper is not a standard layout!");

struct RecordSettings
{
	RecordSettings(
	    RecordFlags flags_ = RecordFlags(),
...
static_assert(
    sizeof(RecordSettings) == sizeof(VmaRecordSettings),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<RecordSettings>::value,
    "struct wrapper is not a standard layout!");

struct AllocatorCreateInfo
{
	AllocatorCreateInfo(
	    AllocatorCreateFlags flags_ = AllocatorCreateFlags(),
	    ...
	    : flags(flags_), physicalDevice(physicalDevice_), device(device_),
	      ...
	      frameInUseCount(frameInUseCount_), pHeapSizeLimit(pHeapSizeLimit_),
	      pVulkanFunctions(pVulkanFunctions_),
	      pRecordSettings(pRecordSettings_), instance(instance_),
	...
	AllocatorCreateInfo &
	setPhysicalDevice(VULKAN_HPP_NAMESPACE::PhysicalDevice physicalDevice_)
	{
	...
	AllocatorCreateInfo &setPreferredLargeHeapBlockSize(
	...
	AllocatorCreateInfo &setPAllocationCallbacks(
	    const VULKAN_HPP_NAMESPACE::AllocationCallbacks *pAllocationCallbacks_)
	{
		pAllocationCallbacks = pAllocationCallbacks_;
		return *this;
	...
	AllocatorCreateInfo &setPDeviceMemoryCallbacks(
	...
	AllocatorCreateInfo &
	setPHeapSizeLimit(const VULKAN_HPP_NAMESPACE::DeviceSize *pHeapSizeLimit_)
	{
	...
	AllocatorCreateInfo &
	setPVulkanFunctions(const VulkanFunctions *pVulkanFunctions_)
	{
		pVulkanFunctions = pVulkanFunctions_;
		return *this;
	}
	...
	AllocatorCreateInfo &
	setPRecordSettings(const RecordSettings *pRecordSettings_)
	{
	...
	bool operator==(AllocatorCreateInfo const &rhs) const
	{
		return (flags == rhs.flags) && (physicalDevice == rhs.physicalDevice)
		       ...
		       && (preferredLargeHeapBlockSize
		           == rhs.preferredLargeHeapBlockSize)
...
static_assert(
    sizeof(AllocatorCreateInfo) == sizeof(VmaAllocatorCreateInfo),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<AllocatorCreateInfo>::value,
    "struct wrapper is not a standard layout!");

struct DefragmentationInfo2
{
	DefragmentationInfo2(
	    DefragmentationFlags flags_ = DefragmentationFlags(),
	    ...
	    : flags(flags_), allocationCount(allocationCount_),
	      pAllocations(pAllocations_),
	      pAllocationsChanged(pAllocationsChanged_), poolCount(poolCount_),
	      pPools(pPools_), maxCpuBytesToMove(maxCpuBytesToMove_),
	...
	DefragmentationInfo2 &
	setPAllocationsChanged(VULKAN_HPP_NAMESPACE::Bool32 *pAllocationsChanged_)
	{
	...
	DefragmentationInfo2 &
	setMaxCpuBytesToMove(VULKAN_HPP_NAMESPACE::DeviceSize maxCpuBytesToMove_)
	{
	...
	DefragmentationInfo2 &
	setMaxCpuAllocationsToMove(uint32_t maxCpuAllocationsToMove_)
	{
		maxCpuAllocationsToMove = maxCpuAllocationsToMove_;
		return *this;
	}
	...
	DefragmentationInfo2 &
	setMaxGpuBytesToMove(VULKAN_HPP_NAMESPACE::DeviceSize maxGpuBytesToMove_)
	{
		maxGpuBytesToMove = maxGpuBytesToMove_;
		return *this;
	}
	...
	DefragmentationInfo2 &
	setMaxGpuAllocationsToMove(uint32_t maxGpuAllocationsToMove_)
	{
		maxGpuAllocationsToMove = maxGpuAllocationsToMove_;
		return *this;
	}
	...
	DefragmentationInfo2 &
	setCommandBuffer(VULKAN_HPP_NAMESPACE::CommandBuffer commandBuffer_)
	{
		commandBuffer = commandBuffer_;
		return *this;
	}
...
static_assert(
    sizeof(DefragmentationInfo2) == sizeof(VmaDefragmentationInfo2),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<DefragmentationInfo2>::value,
    "struct wrapper is not a standard layout!");

struct DefragmentationStats
{
	DefragmentationStats(
	    VULKAN_HPP_NAMESPACE::DeviceSize bytesMoved_ = 0,
	    VULKAN_HPP_NAMESPACE::DeviceSize bytesFreed_ = 0,
	    uint32_t allocationsMoved_ = 0,
	    uint32_t deviceMemoryBlocksFreed_ = 0)
	    : bytesMoved(bytesMoved_), bytesFreed(bytesFreed_),
	...
	DefragmentationStats &
	setBytesMoved(VULKAN_HPP_NAMESPACE::DeviceSize bytesMoved_)
	{
	...
	DefragmentationStats &
	setBytesFreed(VULKAN_HPP_NAMESPACE::DeviceSize bytesFreed_)
	{
	...
	DefragmentationStats &
	setDeviceMemoryBlocksFreed(uint32_t deviceMemoryBlocksFreed_)
	{
		deviceMemoryBlocksFreed = deviceMemoryBlocksFreed_;
		return *this;
	}
...
static_assert(
    sizeof(DefragmentationStats) == sizeof(VmaDefragmentationStats),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<DefragmentationStats>::value,
    "struct wrapper is not a standard layout!");
...
struct PoolCreateInfo
{
	PoolCreateInfo(
	    ...
	    uint32_t frameInUseCount_ = 0)
	    : memoryTypeIndex(memoryTypeIndex_), flags(flags_),
	      blockSize(blockSize_), minBlockCount(minBlockCount_),
	      maxBlockCount(maxBlockCount_), frameInUseCount(frameInUseCount_)
	{
	}
...
static_assert(
    sizeof(PoolCreateInfo) == sizeof(VmaPoolCreateInfo),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<PoolCreateInfo>::value,
    "struct wrapper is not a standard layout!");
...
struct PoolStats
{
	PoolStats(
	    ...
	    : size(size_), unusedSize(unusedSize_),
	      allocationCount(allocationCount_),
	      unusedRangeCount(unusedRangeCount_),
	      unusedRangeSizeMax(unusedRangeSizeMax_), blockCount(blockCount_)
	{
	}
	...
	PoolStats &
	setUnusedRangeSizeMax(VULKAN_HPP_NAMESPACE::DeviceSize unusedRangeSizeMax_)
	{
	...
	{
		return (size == rhs.size) && (unusedSize == rhs.unusedSize)
	...
	bool operator!=(PoolStats const &rhs) const { return !operator==(rhs); }
...
static_assert(
    sizeof(PoolStats) == sizeof(VmaPoolStats),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<PoolStats>::value,
    "struct wrapper is not a standard layout!");
...
struct StatInfo
{
	StatInfo(
	    ...
	    VULKAN_HPP_NAMESPACE::DeviceSize unusedRangeSizeMax_ = 0)
	    : blockCount(blockCount_), allocationCount(allocationCount_),
	      unusedRangeCount(unusedRangeCount_), usedBytes(usedBytes_),
	      unusedBytes(unusedBytes_), allocationSizeMin(allocationSizeMin_),
	...
	StatInfo &
	setAllocationSizeMin(VULKAN_HPP_NAMESPACE::DeviceSize allocationSizeMin_)
	{
	...
	StatInfo &
	setAllocationSizeAvg(VULKAN_HPP_NAMESPACE::DeviceSize allocationSizeAvg_)
	{
		allocationSizeAvg = allocationSizeAvg_;
		return *this;
	}
	...
	StatInfo &
	setAllocationSizeMax(VULKAN_HPP_NAMESPACE::DeviceSize allocationSizeMax_)
	{
		allocationSizeMax = allocationSizeMax_;
		return *this;
	}
	...
	StatInfo &
	setUnusedRangeSizeMin(VULKAN_HPP_NAMESPACE::DeviceSize unusedRangeSizeMin_)
	{
		unusedRangeSizeMin = unusedRangeSizeMin_;
		return *this;
	}
	...
	StatInfo &
	setUnusedRangeSizeAvg(VULKAN_HPP_NAMESPACE::DeviceSize unusedRangeSizeAvg_)
	{
		unusedRangeSizeAvg = unusedRangeSizeAvg_;
		return *this;
	}
	...
	operator VmaStatInfo &() { return *reinterpret_cast<VmaStatInfo *>(this); }
	...
	bool operator!=(StatInfo const &rhs) const { return !operator==(rhs); }
...
static_assert(
    sizeof(StatInfo) == sizeof(VmaStatInfo),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<StatInfo>::value,
    "struct wrapper is not a standard layout!");

struct Stats
{
	Stats(
	    StatInfo memoryType_[VK_MAX_MEMORY_TYPES] = {},
	...
	Stats(VmaStats const &rhs) { *reinterpret_cast<VmaStats *>(this) = rhs; }
	...
	operator VmaStats &() { return *reinterpret_cast<VmaStats *>(this); }
	...
	bool operator!=(Stats const &rhs) const { return !operator==(rhs); }
...
static_assert(
    sizeof(Stats) == sizeof(VmaStats),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<Stats>::value,
    "struct wrapper is not a standard layout!");
...
struct Budget
{
	Budget(
	    ...
	    : blockBytes(blockBytes_), allocationBytes(allocationBytes_),
	      usage(usage_), budget(budget_)
	{
	}

	Budget(VmaBudget const &rhs) { *reinterpret_cast<VmaBudget *>(this) = rhs; }
	...
	Budget &
	setAllocationBytes(VULKAN_HPP_NAMESPACE::DeviceSize allocationBytes_)
	{
	...
	operator VmaBudget &() { return *reinterpret_cast<VmaBudget *>(this); }

	bool operator==(Budget const &rhs) const
	{
		return (blockBytes == rhs.blockBytes)
		       && (allocationBytes == rhs.allocationBytes)
		       && (usage == rhs.usage) && (budget == rhs.budget);
	}

	bool operator!=(Budget const &rhs) const { return !operator==(rhs); }
...
static_assert(
    sizeof(Budget) == sizeof(VmaBudget),
    "struct and wrapper have different size!");
static_assert(
    std::is_standard_layout<Budget>::value,
    "struct wrapper is not a standard layout!");

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result
createAllocator(const AllocatorCreateInfo *pCreateInfo, Allocator *pAllocator)
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreateAllocator(
	    reinterpret_cast<const VmaAllocatorCreateInfo *>(pCreateInfo),
	    reinterpret_cast<VmaAllocator *>(pAllocator)));
}
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<Allocator>::type
createAllocator(const AllocatorCreateInfo &createInfo)
{
	Allocator allocator;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreateAllocator(
	        reinterpret_cast<const VmaAllocatorCreateInfo *>(&createInfo),
	        reinterpret_cast<VmaAllocator *>(&allocator)));
	return createResultValue(
	    result,
	    allocator,
	    VMA_HPP_NAMESPACE_STRING "::createAllocator");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::allocateMemory(
    const VULKAN_HPP_NAMESPACE::MemoryRequirements *pVkMemoryRequirements,
    const AllocationCreateInfo *pCreateInfo,
    Allocation *pAllocation,
    AllocationInfo *pAllocationInfo) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaAllocateMemory(
	    m_allocator,
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<Allocation>::type
    ...
    VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo) const
{
	Allocation allocation;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaAllocateMemory(
	        m_allocator,
	        reinterpret_cast<const VkMemoryRequirements *>(
	            &vkMemoryRequirements),
	        reinterpret_cast<const VmaAllocationCreateInfo *>(&createInfo),
	        reinterpret_cast<VmaAllocation *>(&allocation),
	        reinterpret_cast<VmaAllocationInfo *>(
	            static_cast<AllocationInfo *>(allocationInfo))));
	return createResultValue(
	    result,
	    allocation,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::allocateMemory");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result
Allocator::allocateMemoryForBuffer(
    VULKAN_HPP_NAMESPACE::Buffer buffer,
    const AllocationCreateInfo *pCreateInfo,
    Allocation *pAllocation,
    AllocationInfo *pAllocationInfo) const
    ...
    VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo) const
{
	Allocation allocation;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(
	        ::vmaAllocateMemoryForBuffer(
	            m_allocator,
	            static_cast<VkBuffer>(buffer),
	            reinterpret_cast<const VmaAllocationCreateInfo *>(&createInfo),
	...
	return createResultValue(
	    result,
	    allocation,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::allocateMemoryForBuffer");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result
Allocator::allocateMemoryForImage(
    VULKAN_HPP_NAMESPACE::Image image,
    const AllocationCreateInfo *pCreateInfo,
    Allocation *pAllocation,
    AllocationInfo *pAllocationInfo) const
    ...
    VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo) const
{
	Allocation allocation;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaAllocateMemoryForImage(
	        m_allocator,
	        static_cast<VkImage>(image),
	        reinterpret_cast<const VmaAllocationCreateInfo *>(&createInfo),
	        reinterpret_cast<VmaAllocation *>(&allocation),
	...
	return createResultValue(
	    result,
	    allocation,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::allocateMemoryForImage");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::allocateMemoryPages(
    const VULKAN_HPP_NAMESPACE::MemoryRequirements *pVkMemoryRequirements,
    const AllocationCreateInfo *pCreateInfo,
    size_t allocationCount,
    Allocation *pAllocations,
    AllocationInfo *pAllocationInfos) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaAllocateMemoryPages(
	    m_allocator,
	    reinterpret_cast<const VkMemoryRequirements *>(pVkMemoryRequirements),
	    reinterpret_cast<const VmaAllocationCreateInfo *>(pCreateInfo),
	    allocationCount,
	    reinterpret_cast<VmaAllocation *>(pAllocations),
	    reinterpret_cast<VmaAllocationInfo *>(pAllocationInfos)));
}
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
template <typename VectorAllocator>
VULKAN_HPP_INLINE typename VULKAN_HPP_NAMESPACE::ResultValueType<
    std::vector<AllocationInfo, VectorAllocator>>::type
Allocator::allocateMemoryPages(
    const VULKAN_HPP_NAMESPACE::MemoryRequirements &vkMemoryRequirements,
    const AllocationCreateInfo &createInfo,
    VULKAN_HPP_NAMESPACE::ArrayProxy<Allocation> allocations) const
{
	std::vector<AllocationInfo, VectorAllocator> allocationInfos(
	    allocations.size());
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaAllocateMemoryPages(
	        m_allocator,
	        reinterpret_cast<const VkMemoryRequirements *>(
	            &vkMemoryRequirements),
	        reinterpret_cast<const VmaAllocationCreateInfo *>(&createInfo),
	        allocations.size(),
	        reinterpret_cast<VmaAllocation *>(allocations.data()),
	        reinterpret_cast<VmaAllocationInfo *>(allocationInfos.data())));
	return createResultValue(
	    result,
	    allocationInfos,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::allocateMemoryPages");
}
template <typename VectorAllocator>
VULKAN_HPP_INLINE typename VULKAN_HPP_NAMESPACE::ResultValueType<
    std::vector<AllocationInfo, VectorAllocator>>::type
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::bindBufferMemory(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::Buffer buffer) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindBufferMemory(
	    m_allocator,
	    static_cast<VmaAllocation>(allocation),
	    static_cast<VkBuffer>(buffer)));
}
#else
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
Allocator::bindBufferMemory(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::Buffer buffer) const
{
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindBufferMemory(
	        m_allocator,
	        static_cast<VmaAllocation>(allocation),
	        static_cast<VkBuffer>(buffer)));
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::bindBufferMemory");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::bindBufferMemory2(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
    VULKAN_HPP_NAMESPACE::Buffer buffer,
    const void *pNext) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindBufferMemory2(
	    m_allocator,
	    static_cast<VmaAllocation>(allocation),
	    static_cast<VkDeviceSize>(allocationLocalOffset),
	    static_cast<VkBuffer>(buffer),
	    pNext));
}
#else
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
Allocator::bindBufferMemory2(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
    VULKAN_HPP_NAMESPACE::Buffer buffer,
    const void *pNext) const
{
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindBufferMemory2(
	        m_allocator,
	        static_cast<VmaAllocation>(allocation),
	        static_cast<VkDeviceSize>(allocationLocalOffset),
	        static_cast<VkBuffer>(buffer),
	...
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::bindBufferMemory2");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::bindImageMemory(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::Image image) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindImageMemory(
	    m_allocator,
	    static_cast<VmaAllocation>(allocation),
	    static_cast<VkImage>(image)));
}
#else
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
Allocator::bindImageMemory(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::Image image) const
{
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindImageMemory(
	        m_allocator,
	        static_cast<VmaAllocation>(allocation),
	        static_cast<VkImage>(image)));
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::bindImageMemory");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result bindImageMemory2(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::DeviceSize allocationLocalOffset,
    VULKAN_HPP_NAMESPACE::Image image,
    const void *pNext) const;
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindImageMemory2(
	    m_allocator,
	    static_cast<VmaAllocation>(allocation),
	    static_cast<VkDeviceSize>(allocationLocalOffset),
	    static_cast<VkImage>(image),
...
{
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaBindImageMemory2(
	        m_allocator,
	        static_cast<VmaAllocation>(allocation),
	        static_cast<VkDeviceSize>(allocationLocalOffset),
	        static_cast<VkImage>(image),
	...
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::bindImageMemory2");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(
	    ::vmaCheckCorruption(m_allocator, memoryTypeBits));
}
#else
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
Allocator::checkCorruption(uint32_t memoryTypeBits) const
{
	...
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::checkCorruption");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(
	    ::vmaCheckPoolCorruption(m_allocator, static_cast<VmaPool>(pool)));
}
#else
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
Allocator::checkPoolCorruption(Pool pool) const
{
	...
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::checkPoolCorruption");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void
Allocator::getPoolName(Pool pool, const char **ppName) const
{
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void
Allocator::setPoolName(Pool pool, const char *pName) const
{
...
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::createBuffer(
    const VULKAN_HPP_NAMESPACE::BufferCreateInfo *pBufferCreateInfo,
    const AllocationCreateInfo *pAllocationCreateInfo,
    VULKAN_HPP_NAMESPACE::Buffer *pBuffer,
    Allocation *pAllocation,
    AllocationInfo *pAllocationInfo) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreateBuffer(
	    m_allocator,
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<
    std::pair<VULKAN_HPP_NAMESPACE::Buffer, vma::Allocation>>::type
    ...
    VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo) const
{
	...
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreateBuffer(
	        m_allocator,
	        ...
	        reinterpret_cast<VmaAllocationInfo *>(
	            static_cast<AllocationInfo *>(allocationInfo))));
	std::pair<VULKAN_HPP_NAMESPACE::Buffer, vma::Allocation> pair
	    = std::make_pair(buffer, allocation);
	return createResultValue(
	    result,
	    pair,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::createBuffer");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::createImage(
    const VULKAN_HPP_NAMESPACE::ImageCreateInfo *pImageCreateInfo,
    const AllocationCreateInfo *pAllocationCreateInfo,
    VULKAN_HPP_NAMESPACE::Image *pImage,
    Allocation *pAllocation,
    AllocationInfo *pAllocationInfo) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreateImage(
	    m_allocator,
    ...
    VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo) const
{
	...
	vma::Allocation allocation;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreateImage(
	        m_allocator,
	        ...
	        reinterpret_cast<VmaAllocationInfo *>(
	            static_cast<AllocationInfo *>(allocationInfo))));
	std::pair<VULKAN_HPP_NAMESPACE::Image, vma::Allocation> pair
	    = std::make_pair(image, allocation);
	return createResultValue(
	    result,
	    pair,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::createImage");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE void
Allocator::createLostAllocation(Allocation *pAllocation) const
{
...
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result
Allocator::createPool(const PoolCreateInfo *pCreateInfo, Pool *pPool) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreatePool(
	    m_allocator,
	    reinterpret_cast<const VmaPoolCreateInfo *>(pCreateInfo),
	    reinterpret_cast<VmaPool *>(pPool)));
}
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<Pool>::type
Allocator::createPool(const PoolCreateInfo &createInfo) const
{
	Pool pool;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaCreatePool(
	        m_allocator,
	...
	return createResultValue(
	    result,
	    pool,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::createPool");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::defragmentationBegin(
    const DefragmentationInfo2 *pInfo,
    DefragmentationStats *pStats,
    DefragmentationContext *pContext) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaDefragmentationBegin(
	    m_allocator,
...
VULKAN_HPP_INLINE
VULKAN_HPP_NAMESPACE::ResultValueType<DefragmentationContext>::type
Allocator::defragmentationBegin(
    const DefragmentationInfo2 &info,
    VULKAN_HPP_NAMESPACE::Optional<DefragmentationStats> stats) const
{
	DefragmentationContext context;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaDefragmentationBegin(
	        m_allocator,
	        reinterpret_cast<const VmaDefragmentationInfo2 *>(&info),
	        reinterpret_cast<VmaDefragmentationStats *>(
	            static_cast<DefragmentationStats *>(stats)),
	        reinterpret_cast<VmaDefragmentationContext *>(&context)));
	return createResultValue(
	    result,
	    context,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::defragmentationBegin");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result
Allocator::defragmentationEnd(DefragmentationContext context) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaDefragmentationEnd(
	    m_allocator,
	    static_cast<VmaDefragmentationContext>(context)));
}
#else
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<void>::type
Allocator::defragmentationEnd(DefragmentationContext context) const
{
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaDefragmentationEnd(
	        m_allocator,
	        static_cast<VmaDefragmentationContext>(context)));
	return createResultValue(
	    result,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::defragmentationEnd");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void Allocator::destroyBuffer(
    VULKAN_HPP_NAMESPACE::Buffer buffer,
    Allocation allocation) const
{
	::vmaDestroyBuffer(
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void Allocator::destroyImage(
    VULKAN_HPP_NAMESPACE::Image image,
    Allocation allocation) const
{
	::vmaDestroyImage(
...
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result Allocator::findMemoryTypeIndex(
    uint32_t memoryTypeBits,
    const AllocationCreateInfo *pAllocationCreateInfo,
    uint32_t *pMemoryTypeIndex) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaFindMemoryTypeIndex(
	    m_allocator,
	    memoryTypeBits,
	    reinterpret_cast<const VmaAllocationCreateInfo *>(
	        pAllocationCreateInfo),
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<uint32_t>::type
Allocator::findMemoryTypeIndex(
    uint32_t memoryTypeBits,
    const AllocationCreateInfo &allocationCreateInfo) const
{
	uint32_t memoryTypeIndex;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaFindMemoryTypeIndex(
	        m_allocator,
	        memoryTypeBits,
	        reinterpret_cast<const VmaAllocationCreateInfo *>(
	            &allocationCreateInfo),
	...
	return createResultValue(
	    result,
	    memoryTypeIndex,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::findMemoryTypeIndex");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void Allocator::flushAllocation(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::DeviceSize offset,
    VULKAN_HPP_NAMESPACE::DeviceSize size) const
{
...
VULKAN_HPP_INLINE void Allocator::freeMemoryPages(
    size_t allocationCount,
    Allocation *pAllocations) const
{
	::vmaFreeMemoryPages(
	    m_allocator,
	    allocationCount,
...
VULKAN_HPP_INLINE void Allocator::getAllocationInfo(
    Allocation allocation,
    AllocationInfo *pAllocationInfo) const
{
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE AllocationInfo
Allocator::getAllocationInfo(Allocation allocation) const
{
...
VULKAN_HPP_INLINE void Allocator::getMemoryTypeProperties(
    uint32_t memoryTypeIndex,
    VULKAN_HPP_NAMESPACE::MemoryPropertyFlags *pFlags) const
{
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::MemoryPropertyFlags
Allocator::getMemoryTypeProperties(uint32_t memoryTypeIndex) const
{
...
VULKAN_HPP_INLINE void
Allocator::getPoolStats(Pool pool, PoolStats *pPoolStats) const
{
	::vmaGetPoolStats(
	    m_allocator,
	    static_cast<VmaPool>(pool),
	    reinterpret_cast<VmaPoolStats *>(pPoolStats));
}
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE PoolStats Allocator::getPoolStats(Pool pool) const
{
	...
	::vmaGetPoolStats(
	    m_allocator,
	    static_cast<VmaPool>(pool),
	    reinterpret_cast<VmaPoolStats *>(&poolStats));
	return poolStats;
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void Allocator::invalidateAllocation(
    Allocation allocation,
    VULKAN_HPP_NAMESPACE::DeviceSize offset,
    VULKAN_HPP_NAMESPACE::DeviceSize size) const
{
...
VULKAN_HPP_INLINE void Allocator::makePoolAllocationsLost(
    Pool pool,
    size_t *pLostAllocationCount) const
{
...
VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::Result
Allocator::mapMemory(Allocation allocation, void **ppData) const
{
	return static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaMapMemory(
	    m_allocator,
	    static_cast<VmaAllocation>(allocation),
	    ppData));
}
...
Allocator::mapMemory(Allocation allocation) const
{
	void *pData;
	VULKAN_HPP_NAMESPACE::Result result
	    = static_cast<VULKAN_HPP_NAMESPACE::Result>(::vmaMapMemory(
	        m_allocator,
	        static_cast<VmaAllocation>(allocation),
	        &pData));
	return createResultValue(
	    result,
	    pData,
	    VMA_HPP_NAMESPACE_STRING "::Allocator::mapMemory");
}
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/

#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void
Allocator::setAllocationUserData(Allocation allocation, void *pUserData) const
{
...
#ifdef VULKAN_HPP_DISABLE_ENHANCED_MODE
VULKAN_HPP_INLINE void
Allocator::setCurrentFrameIndex(uint32_t frameIndex) const
{
...
Allocator::touchAllocation(Allocation allocation) const
{
	return static_cast<Bool32>(::vmaTouchAllocation(
	    m_allocator,
	    static_cast<VmaAllocation>(allocation)));
}
#else
